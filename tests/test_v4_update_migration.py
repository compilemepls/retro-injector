...
from retro.utils.config import Config, _hmac_fingerprint
...
def test_v4_release_is_detected_from_338(monkeypatch):
    payload = {
        ...
        "body": "v4 changelog",
        "assets": [
            {"name": "Retro Injector_Installer.exe",
             "browser_download_url": "https://github.com/x/Retro Injector_Installer.exe"},
        ],
    }
    ...
    assert exe_url.endswith("Retro Injector_Installer.exe")
