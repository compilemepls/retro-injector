...
def test_cdn_bases_excludes_dead_cachefly_host():
    ...
    # "Hostname not configured" â€” Roblox retired that mirror. Keeping it
    # in the fallback list wasted one full HTTP round-trip per package
    # download attempt. Verified live before removal (see
    # docs/AI_AGENT_HANDBOOK.md Â§ "Roblox CDN inventory"). We also never
    # had the mis-spelled *-cfly.rbxcdn.com host â€” guard against it too.
