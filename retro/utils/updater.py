...
GITHUB_API = "https://api.github.com/repos/compilemepls/retro-injector/releases/latest"
...
# replace RetroInjector.exe even if this process has not fully unwound yet.
...
def download_update(exe_url, new_version, progress_callback=None):
    ...
    try:
        ...
        downloaded = 0
        temp_setup = os.path.join(os.environ.get("TEMP", "."), f"Setup_Retro_{new_version}.exe")
