...
class RobloxManager:
    ...
    def get_stock_versions_root():
        ...
        None. This is the ONLY install Retro Injector writes flag files into — third-party
    ...
    def get_writable_version_dirs():
        ...
        their version dirs at launch. Retro Injector must never overwrite those files — doing
    ...
    def get_running_build_string(self):
        ...
        Roblox process — the exe Retro Injector currently holds a handle to.
    ...
    def apply_fflags_json(flags_dict, prefer_guid=None):
        ...
        # No stock install — try the bootstrapper install Retro Injector detected.
    ...
    def _launch_error_reason(err):
        ...
        return {
            ...
            5: "access denied — try running Retro Injector as administrator",
