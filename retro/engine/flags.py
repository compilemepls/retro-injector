...
class FlagManager:
    ...
    def start_hotkey_listener(self, roblox):
    ...
    def sync_json_to_roblox(self, roblox=None):
    ...
    def start_watchdog(self, roblox):
        ...
        self.start_hotkey_listener(roblox)
    ...
    def apply_flags_hybrid(self, roblox, skip_json=False):
        ...
        try:
            ...
            gated, reason = self._live_writes_gated(roblox)
    ...
    def launch_and_apply(self, roblox):
        ...
        if success:
            ...
            if has_flags:
                ...
                if initialized:
                    ...
                    self.apply_flags_hybrid(roblox)
